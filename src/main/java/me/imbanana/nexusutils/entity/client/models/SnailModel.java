...
public class SnailModel<T extends SnailEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData bone = snail.addChild("bone", ModelPartBuilder.create().uv(0, 13).cuboid(1.0F, -2.0F, -1.0F, 4.0F, 2.0F, 2.0F, new Dilation(0.0F))
		.uv(0, 9).cuboid(-5.0F, -1.0F, -1.0F, 6.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData shell = snail.addChild("shell", ModelPartBuilder.create().uv(0, 0).cuboid(-3.5F, -6.0F, -1.5F, 5.0F, 5.0F, 3.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData eyes = snail.addChild("eyes", ModelPartBuilder.create(), ModelTransform.pivot(4.5F, -2.0F, 0.0F));

		ModelPartData cube_r1 = eyes.addChild("cube_r1", ModelPartBuilder.create().uv(13, 13).cuboid(0.0F, -2.0F, -0.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, -1.0F, 1.5708F, 1.0472F, 1.5708F));

		ModelPartData cube_r2 = eyes.addChild("cube_r2", ModelPartBuilder.create().uv(16, 12).cuboid(0.0F, -2.0F, -0.5F, 0.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 1.0F, -1.5708F, -1.0472F, 1.5708F));
